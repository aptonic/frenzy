...
+ (id)threadSafeCurrentHost
{
	...
	@synchronized(self)
	{
		retVal = [self threadSafeCurrentHost];
	}
...
+ (id)threadSafeHostWithName:(NSString *)name
{
	...
	@synchronized(self)
	{
		retVal = [self threadSafeHostWithName:name];
	}
...
+ (id)threadSafeHostWithAddress:(NSString *)address
{
	...
	@synchronized(self)
	{
		retVal = [self threadSafeHostWithAddress:address];
	}
...
+ (BOOL)threadSafeIsHostCacheEnabled
{
	...
	@synchronized(self)
	{
		retVal = [self threadSafeIsHostCacheEnabled];
	}
