...
<?php include("header.php") ?>
		...
		<div id="lower-container">
			...
			<div id="buy-section">
				<p>Purchase Frenzy</p>
				<a href="https://sites.fastspring.com/frenzyapp/instant/frenzy"><img width="150" height="47" src="images/purchase.jpg"></a>
				<p>$10</p>
				<p>For a limited time only</p><br>
				<div style="margin-left: 38px;" class="share-button">
